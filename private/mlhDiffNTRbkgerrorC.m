function [errorparams logmlh1 bic]=mlhDiffNTRbkgerrorC(initparams,frburstdata,cumindex,indexone,Diffparams,numC,drvintv,drvpnt)
...
logmlh=mlhDiffNTRbkg_MT(initparammat,LUbounds,frburstdata,cumindex,indexone,Diffparams{1},numC);
