function [errorparams logmlh1 bic]=mlhDiffNTR3cDA1ALEXbkgerrorC(initparams,frburstdata,cumindex,indexone,Diffparams,numC,drvintv,drvpnt)
...
numSp=2;
nstate=(length(initparams)+4-3*numC-numSp)/(6+3*numSp);
...
logmlh=mlhDiffNTR3cDA1ALEXbkg_MT(initparammat,LUbounds,frburstdata,cumindex,indexone,Diffparams{1},numC);
