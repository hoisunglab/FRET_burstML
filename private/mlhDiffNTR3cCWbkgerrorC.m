function [errorparams logmlh1 bic]=mlhDiffNTR3cCWbkgerrorC(initparams,frburstdata,cumindex,indexone,Diffparams,numC,drvintv,drvpnt)
...
numSp=2^(numC-1);
nstate=(length(initparams)+2-2*numC-numSp)/(6+numSp);
...
logmlh=mlhDiffNTR3cCWbkg_MT(initparammat,LUbounds,frburstdata,cumindex,indexone,Diffparams{1},numC);
